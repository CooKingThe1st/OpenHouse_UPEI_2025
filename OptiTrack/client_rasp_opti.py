...
This file is a copy of the client provided in the attachments and has been placed
here for convenience. It connects to a TCP server (the NATNet->TCP bridge) and
parses the `id,x,y,z,rotation;...` format used by the bridge.
"""
