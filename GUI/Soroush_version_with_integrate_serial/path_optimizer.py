...
class CoordinateConverter:
    ...
    def canvas_to_real(self, x: float, y: float) -> Tuple[float, float]:
        ...
        Canvas center maps to (0, 0) in real-world coordinates.
        This allows the GUI coordinate system to be centered at the origin,
        making it easier to apply world frame offsets.
        
        Args:
            x, y: Canvas coordinates in pixels
            
        Returns:
            (real_x, real_y) in millimeters, centered at (0, 0)
        """
    ...
    def real_to_canvas(self, real_x: float, real_y: float) -> Tuple[float, float]:
        ...
        Real-world (0, 0) maps to canvas center.
        
        Args:
            real_x, real_y: Real-world coordinates in millimeters (centered at origin)
